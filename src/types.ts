import { createCusttomer, getBooksByCategoryPromise } from './functions';
...
export type CreateCustomerFunctionType = typeof createCusttomer;
...
export type Param3<T> = T extends (a: infer R, b: number, c: infer R) => symbol ? R : never;
